  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Hi, I’m <strong>Anup Goswami</strong> — an aspiring{" "}
          <strong>Data Science & Artificial Intelligence Engineer</strong> and{" "}
        ...
        <p>
            3rd-year B.Tech Computer Science Engineering student with hands-on experience in Python & Machine Learning Projects. Proficient in Python, Pandas, NumPy, scikitlearn, pytorch, tensorflow and data preprocessing. Seeking internship opportunities to apply skills and contribute to
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>K.U.K(Kurukshetra University)</strong> —Kurukshetra,
                  Haryana
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  3rd Year (Pursuing) | GPA: 8.0
                </p>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>+2 High School Charghara</strong> — Giridih,
                  Jharkhand
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  Jharkhand Board | Percentage: 79%
                </p>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>Utkarmit High School Dwarpahari</strong> — Giridih,
                  Jharkhand
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  Jharkhand Board | Percentage: 87.80%
                </p>
